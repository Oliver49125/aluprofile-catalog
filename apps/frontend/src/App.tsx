          ...
          <div className="md:hidden w-full bg-white/98 backdrop-blur-2xl border-t border-slate-200/90 shadow-2xl animate-fadeIn transition-all px-4 py-4 space-y-4 max-h-[calc(100vh-65px)] overflow-y-auto">
            ...
            <div className="space-y-1">
              ...
              <Link
                ...
                className="flex items-center justify-between px-3 py-2.5 rounded-xl font-bold text-sm text-slate-800 hover:bg-slate-100 hover:text-blue-600 transition-colors group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900">{lang === 'de' ? 'Profilsuche' : 'Profile Search'}</p>
                ...
                <span className="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-blue-100 text-blue-700">
                  {overview?.totals?.profiles || profiles.length || 32}+
                </span>
              </Link>
            ...
            <div className="pt-2 border-t border-slate-100 space-y-2">
              ...
              {!!token && (
                <Link
                  ...
                  className="w-full block"
                >
                  <Button className="w-full py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-sky-600 text-white text-xs font-bold shadow-sm transition-all cursor-pointer">
                    <span>{lang === 'de' ? 'Admin-Panel' : 'Admin Panel'}</span>
                  </Button>
                </Link>
              )}
            </div>
